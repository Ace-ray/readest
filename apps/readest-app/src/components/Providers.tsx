...
// Telemetry removed: no PostHog initialization, no consent prompt, no
// opt-in/opt-out state. The app never phones home.
  ...
  useEffect(() => {
    ...
    if (appService) {
      ...
      appService.loadSettings().then(async (settings) => {
        ...
        // Telemetry removed: no finalizeTelemetryDecision call.
